...
class Category(models.Model):
    ...
    title = models.CharField(max_length=100, default="Meuble")
...
class Vendor(models.Model): 
    ...
    title = models.CharField(max_length=100, default="Dikea")
    image = models.ImageField(upload_to=user_directory_path, default="vendor.jpg")
    descreption = models.TextField(null=True, blank=True, default="I am Amazing vendor")
...
class Product(models.Model): 
    ...
    title = models.CharField(max_length=100, default="Good Quality")
    image = models.ImageField(upload_to=user_directory_path, default="product.jpg")
    descreption = models.TextField(null=True, blank=True, default="This is the product")
   ...
   # updated = models.DateTimeField(null=False, blank=True)
...
class CartOrderItems(models.Model):
    ...
    qty = models.CharField(max_length=200, default="1")
    price = models.DecimalField(max_digits=99999999999999, decimal_places=2, default="1.99")
    ...
    def order_img(self):
        return('<img src="/media/%s" width="50" height="50" />' %(self.image))
